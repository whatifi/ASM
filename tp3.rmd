...
matplot(matrix(c(axes,axes,axes),ncol=3),matrix(c(erreurs,erreurs_apprentissage, erreurs_totales),ncol=3), col = c("blue", "red", "green"), xlab = "Nombre de composantes principales", ylab = "Erreurs en Km")
legend("topleft", legend = c("Erreur de prediction", "Erreur d'apprentissage", "Erreur totale"), col = c("blue", "red","green"))
```
